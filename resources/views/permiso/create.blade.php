...
@section('content')
    <div class="x_panel">
        <div class="x_title">
            <h2><i class="fa fa-lock"></i> Permisos <i class="fa fa-angle-right text-danger"></i><small> Nuevo</small></h2>
        ...
        <div class="x_content">
            ...
            {!! Form::open([ 'route' => 'permiso.store', 'id' => 'form', 'method' => 'POST', 'class' => 'uk-form bt-flabels js-flabels', 'data-parsley-validate' => 'on', 'data-parsley-errors-messages-disabled' => 'on']) !!}
