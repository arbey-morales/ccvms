<div class="col-md-2 col-md-offset-2">
    ...
    <a class="btn btn-primary btn-lg" href="#" onClick="descargarPdf()" class="button" data-toggle="tooltip" data-placement="bottom" title="" data-original-title=".Pdf"> <i class="fa fa-cloud-download"></i> Descargar</a>
