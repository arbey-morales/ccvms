...
@section('content') 
    ...
    <div class="x_panel">
        <div class="x_title">
        <h2> <i class="fa fa-bug"></i> Fallas Contenedores  <i class="fa fa-angle-right text-danger"></i><small> Lista</small></h2>
        @role('root|red-frio')
            @permission('create.catalogos')
                <a class="btn btn-default pull-right" href="{{ url('catalogo/red-frio/falla-contenedor/create') }}" role="button">Nueva falla en contenedor</a>
            @endpermission 
        @endrole
        <div class="clearfix"></div>
        </div>
        <div class="x_content">
             @include('catalogo.falla-contenedor.list')
        </div>
    </div>
    <!-- Modal delete -->
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body">
                <h3>Seguro que quiere eliminar la falla del contenedor: <span id="modal-text" class="text text-danger"></span>?</h3>
            </div>
    ...
    {!! Form::open(['route' => ['catalogo.red-frio.falla-contenedor.destroy', ':ITEM_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
@endsection
@section('my_scripts')
    <!-- Datatables -->
