...
@section('content')
    <div class="x_panel">
        <div class="x_title">
            <h2><i class="fa fa-globe"></i> Colonia <i class="fa fa-angle-right text-danger"></i><small> Nuevo</small></h2>
        ...
        <div class="x_content">
            ...
            {!! Form::open([ 'route' => 'catalogo.colonia.store', 'id' => 'personas-form', 'method' => 'POST', 'class' => 'uk-form bt-flabels js-flabels', 'data-parsley-validate' => 'on', 'data-parsley-errors-messages-disabled' => 'on']) !!}
                    ...
                    <div class="uk-grid uk-grid-collapse">
                        <div class="uk-width-1-2">
                            <div class="bt-flabels__wrapper">
                                ...
                                {!! Form::select('municipios_id', $municipios,  0, ['class' => 'form-control js-data-municipio select2', 'data-parsley-required' => 'true', 'data-parsley-type' => 'number', 'data-parsley-min' => '1', 'id' => 'municipios_id',  'data-placeholder' => '* Municipio', 'style' => 'width:100%'] ) !!}
                        ...
                        <div class="uk-width-1-2">
                            <div class="bt-flabels__wrapper bt-flabels--right">  
                                ...
                                {!! Form::select('ciudades_id', $ciudades,  0, ['class' => 'form-control js-data-ciudad select2', 'data-parsley-required' => 'true', 'data-parsley-type' => 'number', 'data-parsley-min' => '1', 'id' => 'ciudades_id',  'data-placeholder' => '* Ciudad', 'style' => 'width:100%'] ) !!}
                                <span class="bt-flabels__error-desc">Requerido</span>
                            </div>
                        </div>
                    </div>
                    <div class="uk-grid uk-grid-collapse">
                        <div class="uk-width-1-2">
                            <div class="bt-flabels__wrapper"> 
                                ...
                                {!! Form::select('tipos_asentamiento_id', $asentamientos,  0, ['class' => 'form-control js-data-asentamiento select2', 'data-parsley-type' => 'number', 'data-parsley-min' => '0', 'id' => 'tipos_asentamiento_id',  'data-placeholder' => '* Tipo de asentamiento', 'style' => 'width:100%'] ) !!}
                                <span class="bt-flabels__error-desc">Requerido</span>
                            </div>
                        </div>
                        <div class="uk-width-1-2">
                            <div class="bt-flabels__wrapper">
                                ...
                                {!! Form::select('tipos_zona_id', $zonas, 0, ['class' => 'form-control js-data-zona select2', 'data-parsley-type' => 'number', 'data-parsley-min' => '0', 'id' => 'tipos_zona_id',  'data-placeholder' => '* * Tipo de zona', 'style' => 'width:100%'] ) !!}
                                <span class="bt-flabels__error-desc">Requerido</span>
                            </div>
                        </div>
                    </div>
