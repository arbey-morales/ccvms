...
@section('content')
    <div class="x_panel">
        <div class="x_title">
        <h2><i class="fa fa-flag-checkered"></i> Modelos <i class="fa fa-angle-right text-danger"></i><small> Editar</small></h2>
        ...
        <div class="x_content">
            ...
            {!! Form::model($data, ['route' => ['catalogo.red-frio.modelo.update', $data], 'method' => 'PUT', 'class' => 'uk-form bt-flabels js-flabels', 'data-parsley-validate' => '', 'data-parsley-errors-messages-disabled' => '']) !!}
