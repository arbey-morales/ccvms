...
@section('content') 
    ...
    <div class="x_panel">
        <div class="x_title">
        <h2>Localidades  <i class="fa fa-angle-right text-danger"></i><small> Lista</small></h2>
        @role('root|admin')@permission('create.catalogos')<a class="btn btn-default pull-right" href="{{ route('catalogo.localidad.create') }}" role="button">Nueva localidad</a>@endpermission @endrole
        <div class="clearfix"></div>
        </div>
        <div class="x_content">
             @include('catalogo.localidad.list')
        </div>
    </div>
    ...
    {!! Form::open(['route' => ['catalogo.localidad.destroy', ':ITEM_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
@endsection
@section('my_scripts')
    <!-- Datatables -->
