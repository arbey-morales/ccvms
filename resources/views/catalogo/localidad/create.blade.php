...
@section('content')
    <div class="x_panel">
        <div class="x_title">
            <h2><i class="fa fa-globe"></i> Localidad <i class="fa fa-angle-right text-danger"></i><small> Nuevo</small></h2>
        ...
        <div class="x_content">
            ...
            {!! Form::open([ 'route' => 'catalogo.localidad.store', 'id' => 'personas-form', 'method' => 'POST', 'class' => 'uk-form bt-flabels js-flabels', 'data-parsley-validate' => 'on', 'data-parsley-errors-messages-disabled' => 'on']) !!}
                    ...
                    <div class="uk-grid uk-grid-collapse">                        
                        <div class="uk-width-1-2">
                            <div class="bt-flabels__wrapper">
                                ...
                                {!! Form::text('clave', null , ['class' => 'form-control', 'data-parsley-required' => 'true', 'id' => 'clave', 'autocomplete' => 'off', 'placeholder' => '* Clave' ]  ) !!}
                    ...
                    <div class="uk-grid uk-grid-collapse">
                        ...
                        <div class="uk-width-1-2">
                            <div class="bt-flabels__wrapper bt-flabels--right"> 
                                ...
                                {!! Form::text('clave_carta', 'S/C', ['class' => 'form-control', 'id' => 'clave_carta', 'autocomplete' => 'off', 'placeholder' => 'Clave carta' ]  ) !!}
                    ...
                    <div class="uk-grid uk-grid-collapse">
                        ...
                        <div class="uk-width-1-2">
                            <div class="bt-flabels__wrapper">
                                ...
                                {!! Form::text('numero_longitud', null , ['class' => 'form-control', 'id' => 'numero_longitud', 'autocomplete' => 'off', 'placeholder' => 'Número longitud' ]  ) !!}
                                <span class="bt-flabels__error-desc"> </span>
                            </div>
                        </div>
                    </div>
                    <div class="uk-grid uk-grid-collapse">
                        <div class="uk-width-1-2">
                            <div class="bt-flabels__wrapper"> 
                                ...
                                {!! Form::text('numero_altitud', null , ['class' => 'form-control', 'id' => 'numero_altitud', 'autocomplete' => 'off', 'placeholder' => 'Número altitud' ]  ) !!}
                                <span class="bt-flabels__error-desc"> </span>
                            </div>
                        </div>
                        <div class="uk-width-1-2">
