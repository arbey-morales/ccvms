...
@section('content') 
    ...
    <div class="x_panel">
        <div class="x_title">
        <h2><i class="fa fa-hospital-o"></i> CLUE's  <i class="fa fa-angle-right text-danger"></i><small> Lista</small></h2>
        {!! Form::open([ 'route' => 'catalogo.clue.index', 'class' => 'col-md-4', 'method' => 'GET']) !!}
            {!! Form::text('q', $q, ['class' => 'form-control', 'id' => 'q', 'autocomplete' => 'off', 'placeholder' => 'Buscar por Nombre' ]) !!}
        {!! Form::close() !!}

        @role('root|admin')@permission('create.catalogos')<a class="btn btn-default pull-right" href="{{ route('catalogo.clue.create') }}" role="button">Nueva CLUE</a>@endpermission @endrole
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body">
                <h3>Seguro que quiere eliminar lo datos de la CLUE: <span id="modal-text" class="text text-danger"></span>?</h3>
            </div>
    ...
    {!! Form::open(['route' => ['catalogo.clue.destroy', ':ITEM_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
@endsection
@section('my_scripts')
    <!-- Datatables -->
