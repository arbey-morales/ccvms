...
@section('content')
    <div class="x_panel">
        <div class="x_title">
            <h2><i class="fa fa-hospital-o"></i> CLUE <i class="fa fa-angle-right text-danger"></i><small> Editar</small></h2>
        ...
        <div class="x_content">
            ...
            {!! Form::model($data, ['route' => ['catalogo.clue.update', $data], 'method' => 'PUT', 'class' => 'uk-form bt-flabels js-flabels', 'data-parsley-validate' => '', 'data-parsley-errors-messages-disabled' => '']) !!}
                    ...
                    <div class="uk-grid uk-grid-collapse">
                        ...
                        <div class="uk-width-1-2">
                            <div class="bt-flabels__wrapper">
                                ...
                                {!! Form::select('tipos_unidades_id', $tipos_unidades, $data->tipos_unidades_id, ['class' => 'form-control js-data-tipos-unidad select2', 'data-parsley-required' => 'true', 'data-parsley-type' => 'number', 'data-parsley-min' => '1', 'id' => 'tipos_unidades_id',  'data-placeholder' => '* Tipo de unidad', 'style' => 'width:100%'] ) !!}
                    ...
                    <div class="uk-grid uk-grid-collapse">
                        <div class="uk-width-1-2">
                            <div class="bt-flabels__wrapper">
                                ...
                                {!! Form::select('jurisdicciones_id', $jurisdicciones, $data->jurisdicciones_id, ['class' => 'form-control js-data-jurisdiccion select2', 'data-parsley-required' => 'true', 'data-parsley-type' => 'number', 'data-parsley-min' => '1', 'id' => 'jurisdicciones_id',  'data-placeholder' => '* Jurisdicción', 'style' => 'width:100%'] ) !!}
                                <span class="bt-flabels__error-desc">Requerido</span>
                            </div>
                        </div>
                        <div class="uk-width-1-2">
                    ...
                    <div class="uk-grid uk-grid-collapse">
                        <div class="uk-width-1-2">
                            <div class="bt-flabels__wrapper">
                                ...
                                {!! Form::select('localidades_id', [], $data->localidades_id, ['class' => 'form-control js-data-localidad select2', 'data-parsley-required' => 'true', 'data-parsley-type' => 'number', 'data-parsley-min' => '1', 'id' => 'localidades_id',  'data-placeholder' => '* Localidad', 'style' => 'width:100%'] ) !!}
                                <span class="bt-flabels__error-desc">Requerido</span>
                            </div>
                        </div>
                        <div class="uk-width-1-2">
                            <div class="bt-flabels__wrapper bt-flabels--right">   
                                ...
                                {!! Form::select('instituciones_id', $instituciones,  $data->instituciones_id, ['class' => 'form-control js-data-institucion select2', 'data-parsley-type' => 'number', 'data-parsley-min' => '0', 'id' => 'instituciones_id',  'data-placeholder' => '* Afilación', 'style' => 'width:100%'] ) !!}
                                <span class="bt-flabels__error-desc">Requerido</span>
                            </div>
                        </div>
                    </div>
