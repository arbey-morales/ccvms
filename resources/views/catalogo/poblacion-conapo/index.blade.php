...
@section('content') 
    ...
    <div class="x_panel">
        ...
        <div class="row">
            <div class="col-md-4">
                <h2>Población CONAPO  <i class="fa fa-cloud"></i> </h2> 
            </div>
            <div class="col-md-4">
                {!! Form::open([ 'route' => 'catalogo.poblacion-conapo.index', 'id' => 'form', 'method' => 'GET']) !!}
            ...
            <div class="col-md-4">
                @role('root|admin')
                    @permission('create.catalogos')
                        <a class="btn btn-default pull-right" href="{{ route('catalogo.poblacion-conapo.create') }}" role="button">Agregar/Cambiar población</a>
                    @endpermission 
                @endrole
            </div>
        </div>
